...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("600shaders/phong_depth_peel.vert.glsl", &vertexSource);
    glusFileLoadText("600shaders/phong_depth_peel.frag.glsl", &fragmentSource);
	...
	glusFileLoadText("600shaders/fullscreen_blend.vert.glsl", &vertexSource);
	glusFileLoadText("600shaders/fullscreen_blend.frag.glsl", &fragmentSource);
