...
/* On macOS, compile with...
    clang -o camera 520mainCamera.c -lglfw -framework OpenGL; ./camera
*/
...
void handleKey(GLFWwindow *window, int key, int scancode, int action,
    ...
    if (action == GLFW_PRESS && key == GLFW_KEY_L) {
        ...
        //     printf("Angle: phi %g (pi/%g), theta %g (pi/%g), distance %g\n", 
        //         cam.phi, M_PI/cam.phi, cam.theta, M_PI/cam.theta, cam.distance);
        // }
    }
}
